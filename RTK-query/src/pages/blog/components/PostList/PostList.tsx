...
import { startEditPost } from 'pages/blog/blogSlice'
...
export default function PostList() {
  ...
  const { data, isFetching } = useGetPostsQuery() // fetch API
      ...
      <div className='bg-white py-6 sm:py-8 lg:py-12'>
        <div className='mx-auto max-w-screen-xl px-4 md:px-8'>
          <div className='mb-10 md:mb-16'>
            <h2 className='mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl'>Redux Toolkit</h2>
